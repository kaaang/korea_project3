...
public class SettingAdapter extends RecyclerView.Adapter<SettingAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull SettingAdapter.CustomViewHolder holder, int position) {
        ...
        holder.deleteBike.setOnClickListener(v -> {

            AlertDialog.Builder builder= new AlertDialog.Builder(MainActivity._main);
            builder.setTitle("내 바이크 삭제");
            builder.setMessage("선택한 바이크을 삭제하시겠습니까?");
            builder.setPositiveButton("예", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {

                    setJava.deleteBike(main.myBikeId);
                }
            });
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder{
        ...
        protected ImageView deleteBike;
        ...
        public CustomViewHolder(View view) {
            ...
            this.deleteBike = (ImageView) view.findViewById(R.id.deleteBike);
        }
    }
}
